...
class Roles(BaseModel):
    ...
    Attributes:
        ...
        end_year (int | None): Year the role will/has ended. Defaults to
                                  None.
        approved (bool): Whether the role is approved. Defaults to False.
        approval_time (str | None): Time the role was approve. Defaults to
                                       None.
        rejected (bool): Whether the role was rejected. Defaults to False.
        rejection_time (str | None): Time the role was rejected. Defaults
                                        to None.
