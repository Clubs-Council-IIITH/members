...
class Roles(BaseModel):
    ...
    Attributes:
        rid (str): Unique Identifier for a role, a role id, it is autogenerated. Defaults to None.
        name (str): Name of the role
        start_year (int): Year the role started
        end_year (Optional[int]): Year the role will/has ended. Defaults to None.
        approved (bool): Whether the role is approved. Defaults to False.
        approval_time (Optional[str]): Time the role was approve. Defaults to None.
        rejected (bool): Whether the role was rejected. Defaults to False.
        rejection_time (Optional[str]): Time the role was rejected. Defaults to None.
...
class Member(BaseModel):
    ...
    Attributes:
        ...
        last_edited_time (str): Time the member's information was last edited. Defaults to None.
