...
def downloadMembersData(details: MemberInputDataReportDetails, info: Info) -> MemberCSVResponse:
    ...
    results = membersdb.find({"cid": details.cid}, {"_id": 0})
    ...
    headerMapping = {"cid": "Club Name", "uid": "Name", "poc": "Is POC", "roles": "Roles"}
    ...
    clubName = getClubDetails(details.cid, info.context.cookies)["name"]
